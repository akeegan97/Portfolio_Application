...
wxVariant InvestorPositionDisplay::GetValue(int col)const{
    ...
    case 6: return wxVariant(positionPtr->returnOfCapital);break;
    case 7: return wxVariant(positionPtr->percentOwnership);break;
...
void InvestorPositionDisplay::SetValue(int col, const wxVariant &v){
    switch(col){
        ...
        case 6: positionPtr->returnOfCapital = v.GetDouble();break;
        case 7: positionPtr->percentOwnership = v.GetDouble();break;
    }
}

std::vector<wxString> InvestorPositionDisplay::columnNames = {"Investor", "Type","Date Invested","Subscribed", "Paid", "Deployed","Return of Capital","Ownership %"};
std::vector<int> InvestorPositionDisplay::columnWidths = {120,100,150,100,125,175,175,150};