...
bool RugenBerg::OnInit()
{
    ...
    jsonFilePath = resourcePath + "/data/FundTesting2.json";
    #elif defined(__WXMSW__)
    jsonFilePath = "../resources/data/FundTesting2.json";
    #endif
    ...
    MainFrame *frame = new MainFrame("rugenberg", wxDefaultPosition, wxSize(1400, 800), portfolio);
    frame->Show(true);
    return true;
}
